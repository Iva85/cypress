...
describe("Registration test", () => {
    ...
    it ('Register', () => {
        cy.get(locators.register.firstName).clear().type('Iva1')
        cy.get(locators.register.lastName).clear().type('Test1')
        cy.get(locators.register.email).clear().type('ivatest11@test.com')
        cy.get(locators.register.password).clear().type('test1234')
        cy.get(locators.register.password-confirmation).clear().type('test1234')
        cy.get(locators.register.terms).check()
        cy.get(locators.register.submit).click()
    })*/
    it ('Register without first name', () => {
        cy.get(locators.register.lastName).type(faker.name.lastName())
        cy.get(locators.register.email).type('ivatest2@test.com')
        cy.get(locators.register.password).type('test1234')
    ...
    it ('Register without last name', () => {
        ...
        cy.get(locators.register.email).clear().type('ivatest2@test.com')
        cy.get(locators.register.password).clear().type('test1234')
    ...
    it ('Register without email', () => {
        cy.get(locators.register.firstName).clear().type('Iva2')
        cy.get(locators.register.lastName).clear().type('Test2')
    ...
    it ('Register without @ and domain', () => {
        cy.get(locators.register.firstName).clear().type('Iva2')
        cy.get(locators.register.lastName).clear().type('Test2')
        cy.get(locators.register.email).clear().type('ivatest111')
        cy.get(locators.register.password).clear().type('test1234')
        cy.get(locators.register.passwordConfirmation).clear().type('test1234')
        cy.get(locators.register.terms).check()
        cy.get(locators.register.submit).click()
    ...
    it ('Register with existing email', () => {
        cy.get(locators.register.firstName).clear().type('Iva2')
        cy.get(locators.register.lastName).clear().type('Test2')
        cy.get(locators.register.email).clear().type('ivatest111@test.com')
        cy.get(locators.register.password).clear().type('test1234')
        cy.get(locators.register.passwordConfirmation).clear().type('test1234')
        cy.get(locators.register.terms).check()
        cy.get(locators.register.submit).click()
